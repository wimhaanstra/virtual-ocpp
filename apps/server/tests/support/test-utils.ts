...
export function createTestDatabase() {
  ...
  sqlite.exec(`
    ...
    CREATE INDEX communication_journal_created_at_id_idx ON communication_journal (created_at, id);
    CREATE INDEX communication_journal_source_idx ON communication_journal (source_type, source_id);
    CREATE INDEX communication_journal_source_created_at_idx ON communication_journal (source_type, source_id, created_at, id);
    CREATE INDEX communication_journal_target_idx ON communication_journal (target_type, target_id);
    CREATE INDEX communication_journal_target_created_at_idx ON communication_journal (target_type, target_id, created_at, id);
    CREATE INDEX communication_journal_charger_id_idx ON communication_journal (charger_id);
    CREATE INDEX communication_journal_charger_created_at_idx ON communication_journal (charger_id, created_at, id);
    CREATE INDEX communication_journal_proxy_target_id_idx ON communication_journal (proxy_target_id);
    CREATE INDEX communication_journal_proxy_target_created_at_idx ON communication_journal (proxy_target_id, created_at, id);
