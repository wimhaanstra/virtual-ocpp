...
describe("App", () => {
  ...
  it("shows the global chargers registry, renames chargers, and requires exact delete confirmation", async () => {
    ...
    fireEvent.click(within(firstRow as HTMLElement).getByRole("button", { name: "Edit label" }));
    ...
    const secondRow = screen.getByText("SMART-EVSE-2").closest("tr");
    expect(secondRow).not.toBeNull();
    fireEvent.click(within(secondRow as HTMLElement).getByRole("button", { name: "Delete" }));
